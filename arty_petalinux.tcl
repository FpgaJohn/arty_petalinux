...
#
# arty_petalinux.tcl: Tcl script for re-creating project 'mar_11_2026'
#
# Generated by Vivado on Thu Apr 23 23:45:27 -0400 2026
...
#
# 1. This project restoration tcl script (arty_petalinux.tcl) that was generated.
#
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "[file dirname [file normalize [info script]]]/ip/my_state.v"]"\
  ]
  foreach ifile $files {
...
set _xil_proj_name_ "mar_11_2026"
...
set script_file "arty_petalinux.tcl"
...
set orig_proj_dir "[file normalize "$origin_dir/../mar_11_2026"]"
...
set_property -name "board_part_repo_paths" -value "[file normalize "$origin_dir/../../../Users/johns/AppData/Roaming/Xilinx/Vivado/2024.1/xhub/board_store/xilinx_board_store"] [file normalize "$origin_dir/../../versal/te0950-rd/board_files/TE0950_23_1lse/1.2"]" -objects $obj
...
if { [get_files [list my_state.v]] == "" } {
  import_files -quiet -fileset sources_1 [file normalize "[file dirname [file normalize [info script]]]/ip/my_state.v"]
}
...
if { [get_property IS_LOCKED [ get_files -norecurse [list design_1.bd]] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/../mar_11_2026/mar_11_2026.gen/sources_1/bd/design_1/hdl/design_1_wrapper.v" ]
} else {
